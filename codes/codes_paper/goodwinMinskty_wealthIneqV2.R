############################################################
## reduced_goodwin_minsky_3D_integrated_tuned.R
...
##  - Regime comparisons around Hopf (common initial condition)
##  - Full auxiliary + SFC-style reports + overlay plots
##  - NEW: auto-tune to target omega* band (e.g. 0.60–0.70)
##  - NEW: optional damping preset for smaller ω oscillations
############################################################
...
make_state0_from_ss <- function(ss, perturb = c(e=0.002, omega=-0.002, d=0.02)) {
  c(
    e     = ss$e     + perturb[["e"]],
...
cat("\nDONE. See outputs/reduced3D_tuned/\n")
